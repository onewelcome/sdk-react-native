...
@Singleton
class AnonymousService @Inject constructor(private val secureResourceClient: SecureResourceClient){
    private val applicationDetailsRetrofitClient: ResourcesClient by lazy {
        secureResourceClient.prepareSecuredAnonymousRetrofitClient(ResourcesClient::class.java)
    }
