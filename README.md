...
6. Setup the OneginiConfigModel:
        ...
        You can also put the file in other place but you have to set the path into OneginiSdk. See the Supported Methods: setConfigModelClassName(className) [HERE](#supported_methods).
...
7. Setup the SecurityController(not required):
        Create a SecurityController. Example class you find in the lib("com.onegini.mobile.SecurityController"). See the Supported Methods: setSecurityControllerClassName(className) [HERE](#supported_methods).
