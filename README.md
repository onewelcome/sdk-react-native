...
6. Setup the OneginiConfigModel:
        ...
        1. Keep it as it is.
        2. Move 'OneginiConfigModel' to another place. You have to set the path into OneginiSdk. [Supported Methods:](#supported-methods) setConfigModelClassName(className).
