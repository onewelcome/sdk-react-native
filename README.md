...
| **`setSecurityControllerClassName(className)`**           |  Sets a path the SecurityController. Example "com.onegini.mobile.SecurityController" App Configuration Android point 7. Default class is brought from com.onegini.mobile.SecurityController. This has to be set before startClient().
