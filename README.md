...
| **`setSecurityControllerClassName(className)`**           |  Sets a path the SecurityController. Example "com.onegini.mobile.SecurityController". Default class is brought from com.onegini.mobile.SecurityController. This has to be set before startClient(). More information App Configuration Android point 7
